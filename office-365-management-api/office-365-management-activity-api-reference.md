...
- <span data-ttu-id="9e3fa-121">Audit.AzureActiveDirectory</span><span class="sxs-lookup"><span data-stu-id="9e3fa-121">Audit.AzureActiveDirectory</span></span>
...
- <span data-ttu-id="9e3fa-157">Habilitar un webhook que estaba deshabilitado debido a un exceso de notificaciones con error.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-157">Enable a webhook that was disabled because of excessive failed notifications.</span></span>
...
#### <a name="sample-request"></a><span data-ttu-id="9e3fa-217">Solicitud de muestra</span><span class="sxs-lookup"><span data-stu-id="9e3fa-217">Sample request</span></span>
...
#### <a name="sample-request"></a><span data-ttu-id="9e3fa-278">Solicitud de muestra</span><span class="sxs-lookup"><span data-stu-id="9e3fa-278">Sample request</span></span>
...
#### <a name="sample-response"></a><span data-ttu-id="9e3fa-315">Respuesta de muestra</span><span class="sxs-lookup"><span data-stu-id="9e3fa-315">Sample response</span></span>
...
## <a name="retrieve-resource-friendly-names"></a><span data-ttu-id="9e3fa-361">Recuperar los nombres descriptivos de recurso</span><span class="sxs-lookup"><span data-stu-id="9e3fa-361">Retrieve resource friendly names</span></span>
...
|<span data-ttu-id="9e3fa-410">AF20001</span><span class="sxs-lookup"><span data-stu-id="9e3fa-410">AF20001</span></span>|<span data-ttu-id="9e3fa-411">Falta el parámetro: {0}.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-411">Missing parameter: {0}.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-412">{0} = el nombre del parámetro que falta.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-412">{0} = the name of the missing parameter.</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-413">AF20002</span><span class="sxs-lookup"><span data-stu-id="9e3fa-413">AF20002</span></span>|<span data-ttu-id="9e3fa-414">Tipo de parámetro no válido: {0}.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-414">Invalid parameter type: {0}.</span></span> <span data-ttu-id="9e3fa-415">Tipo esperado: {1}</span><span class="sxs-lookup"><span data-stu-id="9e3fa-415">Expected type: {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-416">{0} = el nombre del parámetro no válido.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-416">{0} = the name of the invalid parameter.</span></span></p></li><li><p><span data-ttu-id="9e3fa-417">{1} = el tipo esperado (int, datetime, guid).</span><span class="sxs-lookup"><span data-stu-id="9e3fa-417">{1} = the expected type (int, datetime, guid).</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-418">AF20003</span><span class="sxs-lookup"><span data-stu-id="9e3fa-418">AF20003</span></span>|<span data-ttu-id="9e3fa-419">{0} de expiración proporcionada se establece en una fecha y hora pasadas.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-419">Expiration {0} provided is set to past date and time.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-420">{0} = la expiración que se pasa en la llamada de API.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-420">{0} = the expiration passed in the API call.</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-421">AF20010</span><span class="sxs-lookup"><span data-stu-id="9e3fa-421">AF20010</span></span>|<span data-ttu-id="9e3fa-422">El identificador de espacio empresarial que se pasa en la dirección URL ({0}) no coincide con el que se pasa en el token de acceso ({1}).</span><span class="sxs-lookup"><span data-stu-id="9e3fa-422">The tenant ID passed in the URL ({0}) does not match the tenant ID passed in the access token ({1}).</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-423">{0} = el identificador de espacio empresarial que se pasa en la dirección URL</span><span class="sxs-lookup"><span data-stu-id="9e3fa-423">{0} = tenant ID passed in the URL</span></span></p></li><li><p><span data-ttu-id="9e3fa-424">{1} = el identificador de espacio empresarial que se pasa en el token de acceso</span><span class="sxs-lookup"><span data-stu-id="9e3fa-424">{1} = tenant ID passed in the access token</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-425">AF20011</span><span class="sxs-lookup"><span data-stu-id="9e3fa-425">AF20011</span></span>|<span data-ttu-id="9e3fa-426">El identificador de espacio empresarial ({0}) especificado no existe en el sistema o se ha eliminado.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-426">Specified tenant ID ({0}) does not exist in the system or has been deleted.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>   <span data-ttu-id="9e3fa-427">{0} = el identificador de espacio empresarial que se pasa en la dirección URL</span><span class="sxs-lookup"><span data-stu-id="9e3fa-427">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-428">AF20012</span><span class="sxs-lookup"><span data-stu-id="9e3fa-428">AF20012</span></span>|<span data-ttu-id="9e3fa-429">El identificador de espacio empresarial ({0}) especificado no está configurado correctamente en el sistema.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-429">Specified tenant ID ({0}) is incorrectly configured in the system.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>    <span data-ttu-id="9e3fa-430">{0} = el identificador de espacio empresarial que se pasa en la dirección URL</span><span class="sxs-lookup"><span data-stu-id="9e3fa-430">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-431">AF20013</span><span class="sxs-lookup"><span data-stu-id="9e3fa-431">AF20013</span></span>|<span data-ttu-id="9e3fa-432">El identificador de espacio empresarial que se pasa en la dirección URL ({0}) no es un GUID válido.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-432">The tenant ID passed in the URL ({0}) is not a valid GUID.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p> <span data-ttu-id="9e3fa-433">{0} = el identificador de espacio empresarial que se pasa en la dirección URL</span><span class="sxs-lookup"><span data-stu-id="9e3fa-433">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-434">AF20020</span><span class="sxs-lookup"><span data-stu-id="9e3fa-434">AF20020</span></span>|<span data-ttu-id="9e3fa-435">El tipo de contenido especificado no es válido.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-435">The specified content type is not valid.</span></span>|
|<span data-ttu-id="9e3fa-436">AF20021</span><span class="sxs-lookup"><span data-stu-id="9e3fa-436">AF20021</span></span>|<span data-ttu-id="9e3fa-437">El punto de conexión de webhook {{0}) no se pudo validar.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-437">The webhook endpoint {{0}) could not be validated.</span></span> <span data-ttu-id="9e3fa-438">{1}</span><span class="sxs-lookup"><span data-stu-id="9e3fa-438"></span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-439">{0} = dirección del webhook.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-439">{0} = webhook address.</span></span></p></li><li><p><span data-ttu-id="9e3fa-440">{1} = "El punto de conexión no devolvió HTTP 200".</span><span class="sxs-lookup"><span data-stu-id="9e3fa-440">{1} = "The endpoint did not return HTTP 200."</span></span> <span data-ttu-id="9e3fa-441">o bien, "La dirección debe comenzar con HTTPS".</span><span class="sxs-lookup"><span data-stu-id="9e3fa-441">or "The address must begin with HTTPS."</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-442">AF20022</span><span class="sxs-lookup"><span data-stu-id="9e3fa-442">AF20022</span></span>|<span data-ttu-id="9e3fa-443">No se encontró ninguna suscripción para el tipo de contenido especificado.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-443">No subscription found for the specified content type.</span></span>|
|<span data-ttu-id="9e3fa-444">AF20023</span><span class="sxs-lookup"><span data-stu-id="9e3fa-444">AF20023</span></span>|<span data-ttu-id="9e3fa-445">{0} ha deshabilitado la suscripción.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-445">The subscription was disabled by {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-446">{0} = "un administrador de espacio empresarial" o "un administrador de servicio"</span><span class="sxs-lookup"><span data-stu-id="9e3fa-446">{0} = "a tenant admin" or "a service admin"</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-447">AF20030</span><span class="sxs-lookup"><span data-stu-id="9e3fa-447">AF20030</span></span>|<span data-ttu-id="9e3fa-448">Se debe especificar la hora de inicio y la hora de finalización (o bien omitirse), con una diferencia menor o igual de 24 horas, y la hora de inicio no debe tener más de siete días de antigüedad. </span><span class="sxs-lookup"><span data-stu-id="9e3fa-448">Start time and end time must both be specified (or both omitted) and must be less than or equal to 24 hours apart, with the start time no more than 7 days in the past.</span></span>|
|<span data-ttu-id="9e3fa-449">AF20031</span><span class="sxs-lookup"><span data-stu-id="9e3fa-449">AF20031</span></span>|<span data-ttu-id="9e3fa-450">Entrada nextPage no válida: {0}.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-450">Invalid nextPage Input: {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-451">{0} = el indicador de página siguiente que se pasa en la dirección URL</span><span class="sxs-lookup"><span data-stu-id="9e3fa-451">{0} = the next page indicator passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-452">AF20050</span><span class="sxs-lookup"><span data-stu-id="9e3fa-452">AF20050</span></span>|<span data-ttu-id="9e3fa-453">No existe el contenido especificado ({0}).</span><span class="sxs-lookup"><span data-stu-id="9e3fa-453">The specified content ({0}) does not exist.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-454">{0} = identificador o dirección URL del recurso</span><span class="sxs-lookup"><span data-stu-id="9e3fa-454">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-455">AF20051</span><span class="sxs-lookup"><span data-stu-id="9e3fa-455">AF20051</span></span>|<span data-ttu-id="9e3fa-456">El contenido solicitado con la clave {0} ya ha expirado.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-456">Content requested with the key {0} has already expired.</span></span> <span data-ttu-id="9e3fa-457">El contenido de más de siete días no se puede recuperar.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-457">Content older than 7 days cannot be retrieved.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-458">•    {0} = identificador o dirección URL del recurso</span><span class="sxs-lookup"><span data-stu-id="9e3fa-458">•    {0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-459">AF20052</span><span class="sxs-lookup"><span data-stu-id="9e3fa-459">AF20052</span></span>|<span data-ttu-id="9e3fa-460">El identificador de contenido {0} en la dirección URL no es válido.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-460">Content ID {0} in the URL is invalid.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-461">{0} = identificador o dirección URL del recurso</span><span class="sxs-lookup"><span data-stu-id="9e3fa-461">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-462">AF20053</span><span class="sxs-lookup"><span data-stu-id="9e3fa-462">AF20053</span></span>|<span data-ttu-id="9e3fa-463">Solo puede haber un idioma en el encabezado Accept-Language.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-463">Only one language may be present in the Accept-Language header.</span></span>|
|<span data-ttu-id="9e3fa-464">AF20054</span><span class="sxs-lookup"><span data-stu-id="9e3fa-464">AF20054</span></span>|<span data-ttu-id="9e3fa-465">Sintaxis incorrecta en el encabezado Accept-Language.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-465">Invalid syntax in Accept-Language header.</span></span>|
|<span data-ttu-id="9e3fa-466">AF429</span><span class="sxs-lookup"><span data-stu-id="9e3fa-466">AF429</span></span>|<span data-ttu-id="9e3fa-467">Demasiadas solicitudes.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-467">Too many requests.</span></span> <span data-ttu-id="9e3fa-468">Método={0}, PublisherId={1}</span><span class="sxs-lookup"><span data-stu-id="9e3fa-468">Method={0}, PublisherId={1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="9e3fa-469">{0} = método HTTP</span><span class="sxs-lookup"><span data-stu-id="9e3fa-469">{0} = HTTP Method</span></span></p></li><li><p><span data-ttu-id="9e3fa-470">{1} = GUID de espacio empresarial usado como PublisherIdentifier</span><span class="sxs-lookup"><span data-stu-id="9e3fa-470">{1} = Tenant GUID used as PublisherIdentifier</span></span></p></li></ul>|
|<span data-ttu-id="9e3fa-471">AF50000</span><span class="sxs-lookup"><span data-stu-id="9e3fa-471">AF50000</span></span>|<span data-ttu-id="9e3fa-472">Se ha producido un error interno.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-472">An internal error occurred.</span></span> <span data-ttu-id="9e3fa-473">Vuelva a intentar realizar la solicitud.</span><span class="sxs-lookup"><span data-stu-id="9e3fa-473">Retry the request.</span></span>|
