...
|[Esquema de inicio de sesión de STS de Azure Active Directory](#azure-active-directory-sts-logon-schema)|Amplía el esquema base de Azure Active Directory con las propiedades específicas para todos los eventos de inicio de sesión de STS de Azure Active Directory.|
...
## <a name="azure-active-directory-sts-logon-schema"></a>Esquema de inicio de sesión de STS de Azure Active Directory
...
Los eventos de Yammer que aparecen en [Buscar el registro de auditoría en el Centro de protección de Office 365](https://support.office.com/en-us/article/Search-the-audit-log-in-the-Office-365-Security-Compliance-Center-0d4d0f35-390b-4518-800e-0c7ec95e946c?ui=en-US&amp;rs=en-US&amp;ad=US) utilizarán este esquema.

|**Parámetros**|**Tipo**|**Obligatorio**|**Descripción**|
|:-----|:-----|:-----|:-----|
|ActorUserId|Edm.String|No|El correo electrónico del usuario que llevó a cabo la operación.|
|ActorYammerUserId|Edm.Int32|No|El id. del usuario que llevó a cabo la operación.|
...
|FileId|Edm.Int32|No|Id. del archivo en la operación. |
...
|MessageId|Edm.Int32|No|Id. del mensaje en la operación.|
|YammerNetworkId|Edm.Int32|No|El id. de la red del usuario que llevó a cabo la operación.|
...
|TargetYammerUserId|Edm.Int32|No|El id. del usuario de destino en la operación.|
|VersionId|Edm.Int32|No|El id. de versión del archivo en la operación.|
...
|MeetupId|Edm.String|No|Un identificador para una reunión ad hoc o programada.|
...
## <a name="microsoft-teams-add-ons-schema"></a>Esquema de complementos de Microsoft Teams
...
|AddOnGuid|Edm.Guid|No|Un identificador único para el complemento que generó el evento.|
|TabType|Edm.String|No|El tipo de pestaña que generó el evento.|
...
## <a name="microsoft-teams-settings-schema"></a>Esquema de configura de Microsoft Teams

|**Parámetros**|**Tipo**|**¿Es obligatoria?**|**Descripción**|
|:-----|:-----|:-----|:-----|
|ModifiedProperty|Common.ModifiedProperty|No|La propiedad modificada. Contendrá los **Name**, **OldValue** y **NewValue** de la propiedad.|
|ExtendedProperties|Collection(Common.NameValuePair)|No|Una lista de propiedades extendidas de la configuración que se ha cambiado. Cada propiedad tendrá un **Name** y **Value**.|

## <a name="office-365-advanced-threat-protection-and-threat-intelligence-schema"></a>Esquema de Protección contra amenazas avanzada de Office 365 y de Inteligencia sobre amenazas

Los eventos de Protección contra amenazas avanzada de Office 365 (ATP) y de Inteligencia sobre amenazas están disponibles para los clientes de Office 365 que tienen una suscripción de ATP, Inteligencia sobre amenazas o E5. Cada evento en la fuente de ATP y de Inteligencia sobre amenazas corresponde a los siguientes que se determinaron que contienen una amenaza:
...
|DetectionType|Self.[DetectionType](#DetectionType)|Sí|El tipo de detección.|
...
### <a name="enum-detectiontype---type-edmint32"></a>Enum: DetectionType - Tipo: Edm.Int32

#### <a name="detectiontype"></a>DetectionType

|**Valor**|**Nombre del miembro**|**Descripción**|
|:-----|:-----|:-----|
|0|Inline|Amenaza detectada en el momento de la entrega.|
|1|Delayed|Amenaza detectada después de la entrega.|
|2|ZAP|Mensajes eliminados por [Purgas automáticas](https://support.office.com/es-ES/article/Zero-hour-auto-purge-protection-against-spam-and-malware-96deb75f-64e8-4c10-b570-84c99c674e15). Los eventos con este tipo de detección normalmente irán precedidos de un mensaje con el tipo de detección "Delayed".|
...
|SourceId|Edm.String|Sí|El identificador para el servicio de Office 365 desde el que se hizo clic en la dirección URL (por ejemplo, Correo, este es el id. de mensaje de red de Exchange Online).|
